...
async function testRealUnlocked() {
  console.log('Spawning Chrome with REAL native User Data dir (unlocked)...');
  ...
  try {
    ...
    console.log('SUCCESS: Logged in X via REAL UNLOCKED profile! Compose textbox found!');
    
    // Save success screenshot
    const successPath = path.join(__dirname, 'x_real_success.png');
    ...
    const failPath = path.join(__dirname, 'x_real_fail.png');
...
testRealUnlocked().catch(console.error);
